#!/bin/bash
# Run metrics for all generated synthetic tables (CPU only, runs sequentially).
#
# Usage:
#   bash path_pipeline/scripts/run_all_metrics.sh
#
# To resume from a specific experiment:
#   START_FROM=5 bash path_pipeline/scripts/run_all_metrics.sh
...
echo "========================================"
echo "Running metrics for ${TOTAL} experiments"
...
for i in "${!EXPERIMENTS[@]}"; do
    ...
    OUTPUT_FILE="output/MIMIC_${EXP}/synthetic_tables_metrics.json"
